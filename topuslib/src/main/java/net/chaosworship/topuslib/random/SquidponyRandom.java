...
public class SquidponyRandom implements Serializable {
     ...
     */
    public SquidponyRandom() {
        this((long) (Math.random() * Long.MAX_VALUE));
    }

    public SquidponyRandom(final long seed) {
        setSeed(seed);
    }
    ...
    public boolean equals(Object o) {
        ...
        SquidponyRandom xoRoRNG = (SquidponyRandom) o;
